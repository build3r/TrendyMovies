...
/**
 * An activity representing a single MyMovie detail screen. This
...
public class MovieDetailActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    */
    ...
    BuilderLogger mLog = new BuilderLogger(MovieDetailActivity.class.getSimpleName());
    Retrofit retrofit;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_mymovie_detail);
        ...
        else
        {
            if(movieDetails.getTrailers()!=null)
            {
                ...
                for (int i=0;i<len;i++)
                {
                    ...
                    v.setOnClickListener(MovieDetailActivity.this);
    ...
    private void populateReviews(Integer id)
    {
        ...
        subscription = call.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Subscriber<Reviews>()
        {
            ...
            public void onError(Throwable e)
            {
                ...
                TextView mTextView = new TextView(MovieDetailActivity.this);
